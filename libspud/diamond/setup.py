...
for plugin in plugin_dirs:
  if prefix is None:
    plugin_data_files.append(("/data/phd/fluidity_dev_bedload/libspud/../share/diamond/plugins/" + plugin,
...
gui_data_files = []
if prefix is None:
  gui_data_files.append(("/data/phd/fluidity_dev_bedload/libspud/../share/diamond/gui",
